...
export class GptController {
  ...
  async prosConsDicusserStream(
    ...
    @Res() res: Response, //para configuracion de stream
  ) {
    const stream =
    ...
    for await (const chunk of stream) { //for await para el stream, si fuera solo una promesa seria solo await
  ...
  @Post('audio-to-text')
  @UseInterceptors( //UseInterceptors y FileInterceptor vienen de Nest
